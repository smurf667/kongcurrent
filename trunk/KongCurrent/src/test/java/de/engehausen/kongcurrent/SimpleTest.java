...
public class SimpleTest extends AbstractMonitorTest {
	...
	public void testProxying1() throws Exception {
		...
		assertTrue(collection.isEmpty() == monitored.isEmpty());
		assertTrue(collection.contains(helloWorld) == collection.contains(helloWorld));
		final String nonExistent = "ne";
		assertTrue(collection.contains(nonExistent) == collection.contains(nonExistent));
